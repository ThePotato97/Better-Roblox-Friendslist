...
export const baseConfig: webpack.Configuration = {
  ...
  entry: {
    ...
    'content-script': [path.resolve(userConfig.projectRoot, 'src/pages/content-script/index.ts')],
    options: [path.resolve(userConfig.projectRoot, 'src/pages/options/index.tsx')],
