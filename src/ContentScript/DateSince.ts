const DateSince = (date: Date, relativeTo?: Date, short = false) => {
  ...
  if (y >= 1) {
    return (
      Math.floor(y) + (short ? " yr" : " year" + (y < 2 ? "" : "s")) + " ago"
    );
  }
  ...
  if (M >= 1) {
    return (
      Math.floor(M) + (short ? " mon" : " month" + (M < 2 ? "" : "s")) + " ago"
    );
  }
  ...
  if (w >= 1) {
    return (
      Math.floor(w) + (short ? " wk" : " week" + (w < 2 ? "" : "s")) + " ago"
    );
  }
  ...
  if (d >= 1) {
    return (
      Math.floor(d) + (short ? " dy" : " day" + (d < 2 ? "" : "s")) + " ago"
    );
  }
  ...
  if (h >= 1) {
    return (
      Math.floor(h) + (short ? " hr" : " hour" + (h < 2 ? "" : "s")) + " ago"
    );
  }
  ...
  if (m >= 1) {
    return (
      Math.floor(m) + (short ? " min" : " minute" + (m < 2 ? "" : "s")) + " ago"
    );
  }
